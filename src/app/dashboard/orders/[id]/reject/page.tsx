...
import OrderRejectForm from '@/src/components/admin/OrderRejectForm';
...
export default async function RejectOrderPage({
	params,
}: RejectOrderPageProps) {
