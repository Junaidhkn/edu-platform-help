...
import AssignOrderClient from '@/components/admin/AssignOrderClient';
import db from '@/src/db';
import { freelancers as freelancersSchema, orders as ordersSchema } from '@/src/db/schema';
...
export default async function AssignOrderPage({ params }: AssignOrderPageProps) {
  ...
  const freelancers = await db.select().from(freelancersSchema).orderBy(desc(freelancersSchema.createdAt));
