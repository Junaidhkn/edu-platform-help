...
export default function SubjectCategoriesTable({ categories: initialCategories }: SubjectCategoriesTableProps) {
                ...
                {editingId === category.id ? (
                  <div className="flex items-center">
                    <Input
                      ...
                      onChange={(e) => setEditedModifier(Number(e.target.value))}
                      step="0.1"
                      min="0.1"
                      max="5"
                      className="w-24"
