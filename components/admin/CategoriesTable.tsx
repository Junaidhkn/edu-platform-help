...
export function CategoriesTable({ categories }: CategoriesTableProps) {
  ...
  const handleEdit = (category: Category) => {
    ...
    setEditingValues({
      ...category,
      priceModifier: typeof category.priceModifier === 'string'
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Error updating category');
                  ...
                  {editingId === category.id ? (
                    <div className="flex items-center">
                      <Input
                        ...
                        onChange={(e) => handleInputChange('priceModifier', e.target.value)}
                    ...
                    `${typeof category.priceModifier === 'string'
                      ...
                      : category.priceModifier.toFixed(2)}× base price`
                  )}
                </TableCell>
