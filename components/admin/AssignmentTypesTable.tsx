...
export default function AssignmentTypesTable({ assignmentTypes: initialTypes }: AssignmentTypesTableProps) {
              ...
              <TableCell>
                {editingId === type.id ? (
                  <Input
                    ...
                    onChange={(e) => setEditedAdjustment(Number(e.target.value))}
                    step="1"
                    min="0"
                    className="w-24"
                  />
