...
import FreelancerTable, { Freelancer } from '@/components/admin/FreelancerTable';
...
export default function AssignOrderClient({ orderId, freelancers }: AssignOrderClientProps) {
